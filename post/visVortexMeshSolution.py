...
dat_filename_fmt = "./data/density_{:06}.dat"
msh_filename_fmt = "./data/mesh_{:06d}.dat"
fig_filename_fmt = "./figures/fig_{:06d}.png"

domain_offset_x   = -6.0
domain_offset_y   = -6.0
num_patches       = 6
domain_bounds     = [(-6, 6), (-6, 6)]
