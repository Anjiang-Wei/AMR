...
config.num_base_patches_i =  1; -- number of base-level patches in i-direction
config.num_base_patches_j =  1; -- number of base-level patches in j-direction
config.patch_size         = 2560; -- number of grid points within each patch in each direction
...
config.domain_length_x =  0.6 -- physical domain length in x-direction
config.domain_length_y =  0.6 -- physical domain length in y-direction
config.domain_shift_x  = -0.3 -- physical domain coordinate shift in x-direction (if no shift, the domain origin is at the lower-left corner of the domain)
config.domain_shift_y  = -0.3 -- physical domain coordinate shift in y-direction (if no shift, the domain origin is at the lower-left corner of the domain)
